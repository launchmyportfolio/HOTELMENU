...
function applyRestaurantDefaults(restaurant = {}) {
  ...
  return {
    ...
    paymentModeEnabled: safe.paymentModeEnabled !== false,
    paymentConfigurationStatus: String(safe.paymentConfigurationStatus || "MISSING").trim().toUpperCase() || "MISSING",
    paymentConfigurationMessage: String(safe.paymentConfigurationMessage || "").trim(),
    paymentConfigurationValidatedAt: normalizeDate(safe.paymentConfigurationValidatedAt),
...
function buildRestaurantAdminSummary(restaurant = {}, options = {}) {
  ...
  return {
    ...
    paymentModeEnabled: normalized.paymentModeEnabled !== false,
    paymentConfigurationStatus: normalized.paymentConfigurationStatus || "MISSING",
    paymentConfigurationMessage: normalized.paymentConfigurationMessage || "",
    paymentConfigurationValidatedAt: normalized.paymentConfigurationValidatedAt || null,
